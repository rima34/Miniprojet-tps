...
if ((isset($_GET['CodeCapteur']) && $_GET['CodeCapteur']!="")&&(isset($_GET['Position']) && $_GET['Position']!="")){
include('db.php');
$CodeCapteur = $_GET['CodeCapteur'];
$Position = $_GET['Position'];


$result = mysqli_query($con,"SELECT * FROM `valeurscapteurs` WHERE `CodeCapteur` ='$CodeCapteur' AND  `Position` ='$Position'");
